...
{   
    ...
    if (Loading != null)   
    {   
		move(Loading,{opacity:0},{complete:function(){
...
window.onload = function(){
	initPage();
	var oWrite=document.getElementById('writeword');
	(function(){
		var writeStr = '欢迎访问Valencia的个人网站，我是一名前端工程师，热衷于学习前端各种新技术，每天不是在找bug，就是在去找bug的路上...';
